...
Reel.create!(item_name: "Certate", size: "5000", description: "Great", price: "70000", item_condition: "good", brand_id: 2, reel_type_id: 1, user_id: 2)
Reel.create(item_name: "Exist", size: "2500", description: "Great", price: "80000", item_condition: "good", brand_id: 2, reel_type_id: 1, user_id: 2)
Reel.create(item_name: "Saltiga", size: "5000", description: "Great", price: "120000", item_condition: "good", brand_id: 2, reel_type_id: 1, user_id: 2)
...
Reel.create(item_name: "Ocea Jigger Grappler Jigging Reel", description: "Great", price: "40000", item_condition: "good", brand_id: 1, reel_type_id: 2, user_id: 2)
